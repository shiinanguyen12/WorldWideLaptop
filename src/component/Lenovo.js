      ...
      <Carousel variant="dark">
        <Carousel.Item>
          <img
            ...
            src="https://cdn.tgdd.vn/Products/Images/44/222649/Slider/vi-vn-lenovo-ideapad-3-15iil05-i5-81we003qvn-thumbvideo.jpg" height="400px"
            alt=""
          />
        </Carousel.Item>
        <Carousel.Item>
          <img
            className="d-block w-100"
            src="https://cdn.tgdd.vn/Products/Images/44/230161/Slider/lenovo-thinkbook-15iil-i3-20sm00d9vn-301020-1030110.jpg" height="400px"
            alt="" />
        </Carousel.Item>
        <Carousel.Item>
          <img
            className="d-block w-100"
            src="https://cdn.tgdd.vn/Products/Images/44/236772/Slider/vi-vn-lenovo-thinkbook-14-g2-itl-i7-20vd003lvn-thumbvideo.jpg" height="400px"
            alt=""
          />
        </Carousel.Item>
      </Carousel>
